...
<style lang="scss" scoped>
	.mainArea {
		...
		width: 100%;
		padding: 30rpx;
		background: linear-gradient(to bottom, #ffffff, #f5f5ff 300rpx);
		...
		.examplePic {
			...
			.decoration {
				...
				top: 56rpx;
				position: absolute;
				background: url('/common/images/index/example_decoration.svg') no-repeat;
			}
