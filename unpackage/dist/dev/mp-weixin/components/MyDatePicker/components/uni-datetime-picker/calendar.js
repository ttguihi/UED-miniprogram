...
const _sfc_main = {
  ...
  created() {
    this.cale = new components_MyDatePicker_components_uniDatetimePicker_util.Calendar({
    ...
    init(date) {
      ...
      if (!date) {
        ...
        if (this.defaultValue && !this.range) {
          ...
          const fullDate = components_MyDatePicker_components_uniDatetimePicker_util.getDate(defaultDate);
          ...
          this.time = components_MyDatePicker_components_uniDatetimePicker_util.getTime(defaultDate, this.hideSecond);
        }
      }
    },
    /**
    ...
    setEmit(name) {
      if (!this.range) {
        ...
        if (this.hasTime && !this.time) {
          this.time = components_MyDatePicker_components_uniDatetimePicker_util.getTime(/* @__PURE__ */ new Date(), this.hideSecond);
        }
      }
      let {
        year,
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/components/MyDatePicker/components/uni-datetime-picker/calendar.js.map
