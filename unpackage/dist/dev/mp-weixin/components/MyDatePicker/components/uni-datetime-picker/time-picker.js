...
const {
  t
} = common_vendor.initVueI18n(components_MyDatePicker_components_uniDatetimePicker_i18n_index.i18nMessages);
const _sfc_main = {
  ...
  watch: {
    modelValue: {
      handler(newVal) {
        if (newVal) {
          this.parseValue(components_MyDatePicker_components_uniDatetimePicker_util.fixIosDateFormat(newVal));
          this.initTime(false);
        } else {
          this.time = "";
    ...
    start: {
      handler(newVal) {
        this.parseDatetimeRange(components_MyDatePicker_components_uniDatetimePicker_util.fixIosDateFormat(newVal), "start");
      },
      immediate: true
    },
    end: {
      handler(newVal) {
        this.parseDatetimeRange(components_MyDatePicker_components_uniDatetimePicker_util.fixIosDateFormat(newVal), "end");
      },
      immediate: true
    },
  ...
  methods: {
    ...
    initTimePicker() {
      if (this.disabled)
        return;
      const value = components_MyDatePicker_components_uniDatetimePicker_util.fixIosDateFormat(this.time);
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/components/MyDatePicker/components/uni-datetime-picker/time-picker.js.map
